...
#define ANCS_TCFG_BLE_SECURITY_EN          0/*是否发请求加密命令*/
void ble_profile_init(void)
{
    printf("ble profile init\n");
    le_device_db_init();

    ble_sm_setup_init(IO_CAPABILITY_DISPLAY_ONLY, SM_AUTHREQ_MITM_PROTECTION | SM_AUTHREQ_BONDING, 7, ANCS_TCFG_BLE_SECURITY_EN);
