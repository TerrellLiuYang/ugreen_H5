...
#define RCSP_ADV_EN												1
#define RCSP_DEVICE_STATUS_ENABLE								0//1		//设备状态信息功能
...
#define UPDATE_MD5_ENABLE            							0		//升级是否支持MD5校验
#else
#define OTA_TWS_SAME_TIME_ENABLE     							1//0		//是否支持TWS同步升级
...
// 默认的功能模块使能
#define RCSP_ADV_NAME_SET_ENABLE        						0//1		// 蓝牙名设置
#define RCSP_ADV_KEY_SET_ENABLE         						0//1		// 按键设置
#define RCSP_ADV_LED_SET_ENABLE         						0		// 灯光设置
#define RCSP_ADV_MIC_SET_ENABLE         						0//1		// mic设置
#define RCSP_ADV_WORK_SET_ENABLE        						0//1		// 模式设置（游戏模式）
#define RCSP_ADV_HALTER_ENABLE									0		// 挂脖功能
#define RCSP_ADV_EQ_SET_ENABLE          						0//1		// eq设置
#define RCSP_ADV_MUSIC_INFO_ENABLE      						0//1		// 音乐信息设置
#define RCSP_ADV_HIGH_LOW_SET									0//1		// 高低音设置
#define RCSP_ADV_FIND_DEVICE_ENABLE     						0//1		// 查找设备设置
#define RCSP_ADV_PRODUCT_MSG_ENABLE     						0//1		// 获取产品信息
...
#define RCSP_ADV_ANC_VOICE     									0//1		// 主动降噪
