                            ...
                            u16 readLen)
{
    ...
    delay_nops(qmi8658_info->iic_delay);
...
#define spi_cs_init() \
    do { \
        gpio_set_mode(qmi8658_info->spi_cs_pin/16,BIT(qmi8658_info->spi_cs_pin%16),PORT_OUTPUT_HIGH); \
    } while (0)
#define spi_cs_uninit() \
    do { \
        gpio_set_mode(qmi8658_info->spi_cs_pin/16,BIT(qmi8658_info->spi_cs_pin%16),PORT_HIGHZ); \
    } while (0)
...
u8 qmi8658_sensor_init(void *priv)
{
    ...
    iic_init(qmi8658_info->iic_hdl, get_iic_config(qmi8658_info->iic_hdl));
    ...
    //I3C
#endif
    gpio_set_mode(IO_PORT_SPILT(qmi8658_int_pin1), PORT_INPUT_FLOATING); //PORT_INPUT_PULLUP_10K,PORT_INPUT_PULLDOWN_10K
    gpio_set_mode(IO_PORT_SPILT(qmi8658_int_pin2), PORT_INPUT_FLOATING); //PORT_INPUT_PULLUP_10K,PORT_INPUT_PULLDOWN_10K
