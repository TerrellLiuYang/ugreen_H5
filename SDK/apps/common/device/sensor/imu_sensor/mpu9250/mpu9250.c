...
void mpu9250_test1()
{
    iic_init(mpu9250_iic_info_test1.iic_hdl, get_iic_config(mpu9250_iic_info_test1.iic_hdl));
    gpio_set_mode(IO_PORT_SPILT(mpu9250_int_pin), PORT_INPUT_FLOATING); //PORT_INPUT_PULLUP_10K,PORT_INPUT_PULLDOWN_10K
...
#endif
    iic_init(mpu9250_info_data.iic_hdl, get_iic_config(mpu9250_info_data.iic_hdl));
//int module io init
...
{
    s16 x = 0, y = 0, z = 0;
    iic_init(mpu9250_iic_info_test2.iic_hdl, get_iic_config(mpu9250_iic_info_test2.iic_hdl));
