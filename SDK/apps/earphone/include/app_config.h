...
#define CUSTOM_A2DP_EN                  0//1
#define USER_PRODUCT_SET_TONE_EN        1       //产线修改默认提示音使能
...
#define CONFIG_TWS_CHANNEL_CHECK_IO           IO_PORTA_05					//上下拉电阻检测引脚
...
/*注意:ANC使能情况下使用差分MIC配置*/
#undef TCFG_AUDIO_MIC0_MODE
#define TCFG_AUDIO_MIC0_MODE 	AUDIO_MIC_CAP_DIFF_MODE
#undef TCFG_AUDIO_MIC1_MODE
...
#define TCFG_AUDIO_CVP_NS_MODE	  	    CVP_DNS_MODE
#define TCFG_AUDIO_DMS_SEL	  	    	DMS_NORMAL
#elif (defined TCFG_AUDIO_CVP_DMS_FLEXIBLE_ANS_MODE) /*话务双MIC+ANS通话*/
#define TCFG_AUDIO_TRIPLE_MIC_ENABLE    DISABLE_THIS_MOUDLE
#define TCFG_AUDIO_DUAL_MIC_ENABLE		ENABLE_THIS_MOUDLE
#define TCFG_AUDIO_CVP_NS_MODE	  	    CVP_ANS_MODE
#define TCFG_AUDIO_DMS_SEL	  	    	DMS_FLEXIBLE
#elif (defined TCFG_AUDIO_CVP_DMS_FLEXIBLE_DNS_MODE) /*话务双MIC+DNS通话*/
#define TCFG_AUDIO_TRIPLE_MIC_ENABLE    DISABLE_THIS_MOUDLE
#define TCFG_AUDIO_DUAL_MIC_ENABLE		ENABLE_THIS_MOUDLE
#define TCFG_AUDIO_CVP_NS_MODE	  	    CVP_DNS_MODE
#define TCFG_AUDIO_DMS_SEL	  	        DMS_FLEXIBLE
#elif (defined TCFG_AUDIO_CVP_3MIC_MODE) /*3MIC通话*/
...
#ifdef TCFG_AUDIO_CVP_DEVELOP_ENABLE			/*通话第三方算法*/
...
#if (!TCFG_ANC_BOX_ENABLE) || (!TCFG_TEST_BOX_ENABLE)
#error "自研ENC、ANC产测必须开启测试盒串口升级 以及 ANC串口调试！！"
#endif
#endif
...
//*********************************************************************************//
     ...
     defined(TCFG_SPEAKER_EQ_NODE_ENABLE)                               || \
