...
const char log_tag_const_v_APP_CHARGE_CALIBRATION = TRUE;
const char log_tag_const_i_APP_CHARGE_CALIBRATION = TRUE;
const char log_tag_const_d_APP_CHARGE_CALIBRATION = TRUE;
...
const char log_tag_const_v_ONLINE_DB  = 1;
const char log_tag_const_i_ONLINE_DB  = 1;
const char log_tag_const_d_ONLINE_DB  = 1;
const char log_tag_const_w_ONLINE_DB  = 1;
