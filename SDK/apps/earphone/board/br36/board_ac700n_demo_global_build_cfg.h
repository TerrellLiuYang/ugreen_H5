#ifndef CONFIG_BOARD_AC700N_DEMO_POST_BUILD_CFG_H
#define CONFIG_BOARD_AC700N_DEMO_POST_BUILD_CFG_H

#include "sdk_config.h"

/* 该文件只添加和isd_config.ini相关的配置，用以生成isd_config.ini */
/* 其他不相关的配置请勿添加在该文件 */
...
#define CONFIG_DOUBLE_BANK_ENABLE               1//TCFG_DUAL_BANK_ENABLE       //单双备份选择(若打开了改宏,FLASH结构变为双备份结构，适用于接入第三方协议的OTA， PS: JL-OTA同样支持双备份升级, 需要根据实际FLASH大小同时配置CONFIG_FLASH_SIZE)
...
#define CONFIG_CHIP_NAME                        AC700N//JL700N//AC700N              //除了SDK发布者,请不要修改
//it can be modified before first programming,but keep the same as the original version
#define CONFIG_PID                              AC700N//JL700N//AC700N              //烧写或强制升级之前可以修改,之后升级要保持一致
//it can be modified before first programming,but keep the same as the original version
...
//br36 support 2 reset pin
//#define CONFIG_SUPPORT_RESET1
#ifdef  CONFIG_SUPPORT_RESET1
#define CONFIG_RESET1_PIN                       LDO
#define CONFIG_RESET1_TIME                      08
#define CONFIG_RESET1_LEVEL                     0
#endif
...
#define CONFIG_VM_OPT							1//0

//config whether erased this area when do a update,1-No Operation,0-Erase
#define CONFIG_BTIF_OPT							1//0
