...
#if ((defined TCFG_AUDIO_CVP_3MIC_MODE) || (defined TCFG_AUDIO_CVP_3MIC_MODE))
...
int cvp_param_cfg_read(void)
{
    ...
    len = jlstream_read_node_data(NODE_UUID_CVP_3MIC, 0XFF, (u8 *)&ncfg);
    if (len != sizeof(ncfg)) {
...
#endif/* TCFG_AUDIO_CVP_3MIC_MODE || TCFG_AUDIO_CVP_3MIC_MODE*/
