...
#if AUD_PDM_LINK_ENABLE

#define ESCO_PDM_SCLK          2400000 /*1M-4M,SCLK/SR需为整数且在1-4096范围*/
#define ESCO_PDM_IRQ_POINTS    256 /*采样中断点数*/
/*读不到配置时的默认io*/
#define  PLNK_SCLK_PIN			IO_PORTA_06
#define  PLNK_DAT0_PIN			IO_PORTA_08
#define  PLNK_DAT1_PIN			IO_PORTA_07
