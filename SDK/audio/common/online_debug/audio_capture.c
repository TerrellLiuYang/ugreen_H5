...
void dm_2_dac_open(u16 sr)
{
    ...
    app_audio_state_switch(APP_AUDIO_STATE_MUSIC, app_audio_volume_max_query(AppVol_BT_MUSIC));
...
int audio_mic_init(u16 sr)
{
    ...
    if (adc_dm) {
        ...
        if (ch & AUDIO_ADC_MIC_0) {
            adc_file_mic_open(&adc_dm->mic_ch, AUDIO_ADC_MIC_0);
        }
        if (ch & AUDIO_ADC_MIC_1) {
            adc_file_mic_open(&adc_dm->mic_ch, AUDIO_ADC_MIC_1);
        }
        if (ch & AUDIO_ADC_MIC_2) {
            adc_file_mic_open(&adc_dm->mic_ch, AUDIO_ADC_MIC_2);
        }
        if (ch & AUDIO_ADC_MIC_3) {
            adc_file_mic_open(&adc_dm->mic_ch, AUDIO_ADC_MIC_3);
        }
        ...
        if (ch & AUDIO_ADC_MIC_0) {
            ...
            mic_param.mic_dcc       = 8;
            audio_adc_mic_open(&adc_dm->mic_ch, AUDIO_ADC_MIC_0, &adc_hdl, &mic_param);
            audio_adc_mic_set_gain(&adc_dm->mic_ch, AUDIO_ADC_MIC_0, mic0_gain);
        ...
        if (ch & AUDIO_ADC_MIC_1) {
            ...
            mic_param.mic_bias_rsel = 4;
            mic_param.mic_dcc       = 8;
            audio_adc_mic_open(&adc_dm->mic_ch, AUDIO_ADC_MIC_1, &adc_hdl, &mic_param);
            audio_adc_mic_set_gain(&adc_dm->mic_ch, AUDIO_ADC_MIC_1, mic1_gain);
        ...
        if (ch & AUDIO_ADC_MIC_2) {
            ...
            mic_param.mic_bias_rsel = 4;
            mic_param.mic_dcc       = 8;
            audio_adc_mic_open(&adc_dm->mic_ch, AUDIO_ADC_MIC_2, &adc_hdl, &mic_param);
            audio_adc_mic_set_gain(&adc_dm->mic_ch, AUDIO_ADC_MIC_2, mic2_gain);
        ...
        if (ch & AUDIO_ADC_MIC_3) {
            ...
            mic_param.mic_bias_rsel = 4;
            mic_param.mic_dcc       = 8;
            audio_adc_mic_open(&adc_dm->mic_ch, AUDIO_ADC_MIC_3, &adc_hdl, &mic_param);
            audio_adc_mic_set_gain(&adc_dm->mic_ch, AUDIO_ADC_MIC_3, mic3_gain);
