...
#define AUDIO_MIC_BIAS_CH1            BIT(1)    // PB7
#define AUDIO_MIC_BIAS_CH2            BIT(2)    // 不支持
#define AUDIO_MIC_BIAS_CH3            BIT(3)    // 不支持
...
void audio_anc_mic_open(audio_adc_mic_mana_t *mic_param, u8 trans_en);
